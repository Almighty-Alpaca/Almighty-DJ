...
//    public abstract void rewind(long milliseconds);
    ...
    AmplitudeAudioInputStream amplitudeStream ;
    ...
    public void setAudioSource(AudioInputStream inSource)
    {
        ...
        amplitudeStream=new AmplitudeAudioInputStream(pcmStream);
        amplitudeStream.setAmplitudeLinear(amplitude);
        ...
        audioFormat = new AudioFormat(
                ...
                toPCM.getFrameRate(),
                true);
        audioSource = AudioSystem.getAudioInputStream(audioFormat, amplitudeStream);
    }
