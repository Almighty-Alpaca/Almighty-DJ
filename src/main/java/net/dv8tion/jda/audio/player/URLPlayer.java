...
public class URLPlayer extends Player
{
    ...
    protected static final String userAgent = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.80 Safari/537.36 " + Requester.USER_AGENT;
    ...
    public void setAudioUrl(URL urlOfResource) throws IOException, UnsupportedAudioFileException
    {
        ...
        this.bufferedResourceStream = new BufferedInputStream(resourceStream, 8 * 1024 * 1024); // 8MB buffer, probably waaaay too big
